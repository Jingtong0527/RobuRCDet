...
SAVE_FIELDS = [0, 1, 2, 5, 8, 9, -1, 4]  # x, y, z, rcs, vx_comp, vy_comp, (dummy field for sweep info)
...
def worker(info):
    ...
    points.tofile(os.path.join(DATA_PATH1, OUT_PATH, file_name))
