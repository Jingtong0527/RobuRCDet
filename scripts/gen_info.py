...
def main():
    ...
    mmcv.dump(train_infos_tiny, 'your/path/nuscenes_infos_train-tiny.pkl')
    train_infos = generate_info(trainval_nusc, train_scenes)
    mmcv.dump(train_infos, 'your/path/nuscenes_infos_train.pkl')
    val_infos = generate_info(trainval_nusc, val_scenes)
    mmcv.dump(val_infos, 'your/path/nuscenes_infos_val.pkl')
