...
data_root = '/data1/public_data/nuscenes/v1.0-trainval'
INFO_PATHS = ['your/path/nuscenes_infos_train.pkl',
              'your/path/nuscenes_infos_val.pkl']
data_root1 = 'your/path/data/nuscenes/'
lidar_key = 'LIDAR_TOP'
cam_keys = [
